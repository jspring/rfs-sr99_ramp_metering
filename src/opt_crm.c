...
###################################################################################################################*/
		...
		for(i=0;i<SecSize;i++)
		{
			    ...
			    fprintf(st_file_out,"%4.2f %4.2f %4.2f %4.2f", mainline_out[i].agg_vol, mainline_out[i].agg_speed, 
		...
		{	
				...
				fprintf(st_file_out,"%4.2f %4.2f %4.2f %4.2f", onramp_out[i].agg_vol, 100.0*(onramp_out[i].agg_occ), offramp_out[i].agg_vol, offramp_out[i].agg_occ);  			
		}
		fprintf(st_file_out,"\n");
