...
###################################################################################################################*/
		...
		for(i=0;i<SecSize;i++)
		{
			    ...
			    fprintf(st_file_out,"check here | %f | %f | %f | %f |", mainline_out[i].agg_vol, mainline_out[i].agg_speed, 
		...
		{	
				...
				fprintf(st_file_out,"check here | %f | %f | %f | %f | ", onramp_out[i].agg_vol, 100.0*(onramp_out[i].agg_occ), offramp_out[i].agg_vol, offramp_out[i].agg_occ);  			
		}
		fprintf(st_file_out,"\n");
